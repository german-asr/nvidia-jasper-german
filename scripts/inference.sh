...
DATA_DIR=${1-"/datasets"}
DATASET=${2:-"test"}
MODEL_CONFIG=${3:-"/code/configs/a_ger_bpetc_jasper3x5_sp_offline_specaugment.toml"}
RESULT_DIR=${4:-"/results"}
CHECKPOINT=${5:-"/results/DistributedDataParallel_1575645425.3428488-epoch-100.pt"}
...
SEED=${10:-0}
BATCH_SIZE=${11:-64}
MODELOUTPUT_FILE=${12:-"$RESULT_DIR/test.logits"}
PREDICTION_FILE=${13:-"$RESULT_DIR/test.predictions"}
...
CMD+=" --val_manifest $DATA_DIR/jasperized/commonvoice_de/test.json,$DATA_DIR/jasperized/tuda/test_Kinect-RAW.json"
