...
DATA_DIR=${1:-"/datasets"}
MODEL_CONFIG=${2:-"/code/configs/ger_letter_jasper3x3_sp_offline_specaugment.toml"}
RESULT_DIR=${3:-"/results"}
CHECKPOINT=${4:-"/results/DistributedDataParallel_1576338917.5310163-epoch-100.pt"}
CREATE_LOGFILE=${5:-"true"}
CUDNN_BENCHMARK=${6:-"false"}
NUM_GPUS=${7:-1}
PRECISION=${8:-"fp32"}
NUM_STEPS=${9:-"-1"}
SEED=${10:-0}
...
CMD+=" --val_manifest=$DATA_DIR/full_jasperized/test.json"
